from tw_auto_scheduler import *
import sys

def tw_grid_search(M, N, K, K_pruned_max, N_pruned_global, dtype, target_name, search_space: list):
    ...
    with open(log_file, 'w') as output_file:
        ...
        min_tile_size = 0 
        for tile_size in search_space:
            print('Try tile_size=%d on %s'%(tile_size, target_name), file=output_file)
...
def main():
    ...
    search_space = [2, 4, 8, 16, 32, 64, 128, 256, 512, 1024]
    dtype = 'float32'
