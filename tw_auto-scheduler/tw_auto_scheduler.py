...
def get_execution_time(M, N, K, tile_size, K_pruned_max, N_pruned_global, dtype, target_name:str):
    ...
    log_file = "./ansor_outputs/tw_{M}_{N}_{K}_{tile_size}_{K_pruned_max}_{N_pruned_global}_{dtype}_{target_name}_trails{trails}.json".format(M=M, N=N, K=K, tile_size=tile_size, K_pruned_max=K_pruned_max, N_pruned_global=N_pruned_global, dtype=dtype, target_name=target_name, trails=ansor_num_trials)
