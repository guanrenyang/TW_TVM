...
def tiled_wise_1d_mix(accumulated_scores, sparsity, granularity = 128, g1percent = 1):
...
def vector_wise(accumulated_scores, sparsity):
    new_mask_values = []
    for layer in range(len(accumulated_scores)):
...
def tw_vw(accumulated_scores,sparsity,granularity = 128):
...
def tw_vw_4choose2(accumulated_scores,sparsity,granularity = 128):
